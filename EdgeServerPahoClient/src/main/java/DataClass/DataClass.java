...
/** Data class will hold the data received from android device
 * It will also hold the command to be sent back to android device
 * It will also be the data object being snt to backhaul server*/
